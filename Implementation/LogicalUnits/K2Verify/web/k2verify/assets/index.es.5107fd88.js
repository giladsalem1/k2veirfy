import { c as commonjsGlobal, _ as _typeof$1 } from "./index.c68a44c7.js";
var es_promise = {};
...
var store$3 = sharedStore$1.exports = globalThis$j[SHARED] || defineGlobalProperty$2(SHARED, {});
...
"use strict";
var store$2 = sharedStore$1.exports;
...
var f$6 = objectGetOwnPropertyDescriptor.f = DESCRIPTORS$9 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O2, P) {
...
var f$5 = objectDefineProperty.f = DESCRIPTORS$7 ? V8_PROTOTYPE_DEFINE_BUG$1 ? function defineProperty(O2, P, Attributes) {
  anObject$e(O2);
  P = toPropertyKey$1(P);
...
var store$1 = sharedStore$1.exports;
...
var shared$1 = sharedStore$1.exports;
...
var f$4 = objectGetOwnPropertyNames.f = Object.getOwnPropertyNames || function getOwnPropertyNames(O2) {
...
var FORCED_PROMISE_CONSTRUCTOR$5 = isForced("Promise", function() {
  ...
  if (!GLOBAL_CORE_JS_PROMISE && V8_VERSION === 66)
    return true;
  if (IS_PURE$8 && !(NativePromisePrototype$2["catch"] && NativePromisePrototype$2["finally"]))
    return true;
...
var f$2 = newPromiseCapability$2.f = function(C) {
...
$$9({ target: "Promise", stat: true, forced: IS_PURE$5 || FORCED_PROMISE_CONSTRUCTOR }, {
...
var f$1 = objectDefineProperties.f = DESCRIPTORS$1 && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O2, Properties) {
  anObject$6(O2);
...
if (NEW_ITERATOR_PROTOTYPE)
  ...
  IteratorPrototype$2 = create$1(IteratorPrototype$2);
...
var iteratorDefine = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED2) {
  ...
  if (anyNativeIterator) {
    ...
    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
      ...
      if (IS_PURE$2)
        Iterators$1[TO_STRING_TAG2] = returnThis;
    }
  }
  ...
  if ((!IS_PURE$2 || FORCED2) && IterablePrototype[ITERATOR$1] !== defaultIterator) {
...
if (!IS_PURE$1 && DESCRIPTORS && values.name !== "values")
  try {
...
var cancel = raf$1.exports.cancel = function() {
  caf.apply(root, arguments);
};
var polyfill = raf$1.exports.polyfill = function(object) {
  if (!object) {
    object = root;
  }
